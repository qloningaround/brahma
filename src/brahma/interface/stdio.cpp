...
GOTCHA_MACRO(fdopen, FILE*, (int fd, const char *mode), (fd, mode), brahma::STDIO);
GOTCHA_MACRO(fileno, int, (FILE *stream), (stream), brahma::STDIO);
GOTCHA_MACRO(tmpfile, FILE*, (void), (void), brahma::STDIO);
GOTCHA_MACRO(fseeko, int, (FILE *stream, off_t offset, int whence), (stream, offset, whence), brahma::STDIO);
